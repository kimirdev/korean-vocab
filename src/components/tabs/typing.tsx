...
const TypingTab = () => {
  ...
  return (
    <div className='max-w-[428px] w-full mx-auto'>
      ...
      <Input name='word' autoComplete='off' autoFocus value={value} onChange={(e) => setValue(e.target.value)} className={` my-5 text-base ${value.trim() === currentWord?.korean ? "border-green-400  focus-visible:ring-green-400" : "border-red-400  focus-visible:ring-red-400"}`} />
